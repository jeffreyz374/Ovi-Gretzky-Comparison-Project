...
These are additional interactive visuals that are derived from the information on all of the goals ever scored by Ovechkin (as of the 2022-23 preseason (September 27 2022)) and Gretzky. Although not relevant to the scope of the project, these visuals still provide a comparison between the individual goal scoring talents of both players.
...
This interactive visual shows the number of goals scored by Ovechkin and Gretzky grouped by the age at which each player scored those goals (as Ovechkin is still active in the NHL, his data is accurate as of September 27 2022):
...
This interactive visual shows the number of goals scored by Ovechkin and Gretzky grouped by the opponent that was scored on (as Ovechkin is still active in the NHL, his data is accurate as of September 27 2022):
...
This interactive visual shows the number of goals scored by Ovechkin and Gretzky grouped by the goalie on which they scored those goals (as Ovechkin is still active in the NHL, his data is accurate as of September 27 2022):
